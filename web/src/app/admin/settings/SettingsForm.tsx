      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Hacienda Knowledge to retain chat messages. Leaving this field empty will cause Hacienda Knowledge to never delete chat messages."
