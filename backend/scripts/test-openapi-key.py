...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Success! Feel free to use this API key for Hacienda Knowledge .")
    except Exception:
        print(
            "Failed, provided API key is invalid for Hacienda Knowledge , please address the error from OpenAI."
        )
        raise
